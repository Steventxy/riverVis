...
<%
	...
	String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+ "/WEB-INF/static/";
%>
<!DOCTYPE html>
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="WEB-INF/static/ace/css/bootstrap.css" />
		<link rel="stylesheet" href="WEB-INF/static/ace/css/font-awesome.css" />
		<!-- page specific plugin styles -->
		<!-- text fonts -->
		<link rel="stylesheet" href="WEB-INF/static/ace/css/ace-fonts.css" />
		<!-- ace styles -->
		<link rel="stylesheet" href="WEB-INF/static/ace/css/ace.css" class="ace-main-stylesheet" id="main-ace-style" />
		<!--[if lte IE 9]>
		...
		<script src="WEB-INF/static/ace/js/ace-extra.js"></script>
...
<body class="no-skin">
	...
	<script src="WEB-INF/static/ace/js/bootstrap.js"></script>
	
	
	<!-- ace scripts -->
	<script src="WEB-INF/static/ace/js/ace/ace.js"></script>
